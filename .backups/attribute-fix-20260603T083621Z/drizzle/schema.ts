...
export const productAttributes = mysqlTable("product_attributes", {
  ...
  // Product-level image driver. Only one assigned attribute per product should be true.
  // When true, this attribute's selected value image/gallery may control the product image.
