...
async function startServer() {
  ...
  // Prevent missing media URLs from falling through to the SPA index.html.
  // Existing files are served above; only unresolved /media/* requests reach this handler.
