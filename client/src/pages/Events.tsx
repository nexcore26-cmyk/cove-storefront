 ...
 * Events — /events/
 *
 * Displays all portfolio items from categories with type='events'.
 * If multiple event categories exist, shows tabs. Otherwise shows a flat grid.
...
export default function Events() {
  ...
  const { data: categories = [], isLoading: catsLoading } = trpc.portfolio.listCategories.useQuery({ type: 'events' });
  ...
  return (
    <Layout>
      <div className="min-h-screen bg-white">
        ...
        {/* Tabs — only shown if more than one event category */}
        {showTabs && (
