...
import AdminCommissionTracking from "./pages/admin/AdminCommissionTracking";
...
import AdminMenuBuilder from "./pages/admin/AdminMenuBuilder";
import AdminHeaderBuilder from "./pages/admin/AdminHeaderBuilder";
import AdminFooterBuilder from "./pages/admin/AdminFooterBuilder";
...
function Router() {
  return (
    <Switch>
      ...
      <Route path="/admin/commissions" component={AdminCommissionTracking} />
      ...
      <Route path="/admin/menu-builder" component={AdminMenuBuilder} />
      <Route path="/admin/header-builder" component={AdminHeaderBuilder} />
      <Route path="/admin/footer-builder" component={AdminFooterBuilder} />
      <Route path="/admin/portfolio" component={AdminPortfolio} />
      <Route path="/admin/pos-dashboard" component={POSDashboard} />
      ...
      <Route path="/cp" component={CompanyPortfolio} />
