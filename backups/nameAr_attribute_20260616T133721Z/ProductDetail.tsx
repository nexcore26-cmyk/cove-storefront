          ...
          <div className="flex flex-col">
                    ...
                    {values.filter((v: any) => v.isEnabled !== false).map((v: any) => {
                      ...
                      return (
                        <button key={v.id}
                          onClick={() => !valueOutOfStock && handleAttributeValueSelect(pa.attributeId, v.id)}
                          disabled={valueOutOfStock && !showroomOnly}
                          className="px-4 py-2 text-xs text-left whitespace-nowrap border transition-all duration-200 disabled:opacity-40 disabled:cursor-not-allowed"
                          style={{
            ...
            {selectedVariant?.htmlBlockEnabled && selectedVariant?.htmlBlockContent?.trim() && (
              <div
                ...
                style={{ color: '#4A4A48', fontFamily: 'Montserrat, sans-serif' }}
            ...
            <div className="border-t pt-6" style={{ borderColor: '#E8E4DC' }}>
              ...
              <div className="text-sm leading-relaxed" style={{ color: '#4A4A48', fontFamily: 'Montserrat, sans-serif' }}>
                {activeTab === 'description' && (
                  <div className="html-content" dangerouslySetInnerHTML={{ __html: cleanDescription((product as any).description || 'No description available.') }} />
                )}
                {activeTab === 'details' && (
                  <div>
