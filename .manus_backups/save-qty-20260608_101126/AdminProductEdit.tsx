...
function VariantMediaTab({ productId }: { productId: number | null }) {
  ...
  const saveVariantWarehouseStock = (variant: any, warehouseId: number, currentQuantity: number) => {
    if (!productId) return;
    ...
    if (delta === 0) {
      toast.info('Warehouse stock is unchanged');
      return;
    }
                                        ...
                                        <div key={warehouse.id} className="rounded-md border p-3 space-y-2">
                                          ...
                                          <div className="flex gap-2">
                                            ...
                                            <Button
                                              type="button"
                                              variant="outline"
                                              disabled={adjustVariantStockMutation.isPending}
